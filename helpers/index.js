...
function serverGetAssertion(userAuthenticators) {
  ...
  const options = generateRegistrationOptions({
    ...
    allowCredentials: userAuthenticators.map((authenticators) => ({
      id: authenticators.credentialID,
      type: "public-key",
      // Optional
      transports: authenticators.transports ? authenticators.transports : [],
    })),
